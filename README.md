...
SSH config entries created by this extension can be removed with **Delete from SSH Config**. Manually written SSH config entries are read-only in the extension and are not deleted or rewritten.
